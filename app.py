...
def scrape_weather():
    ...
    #     soup = BeautifulSoup(response.text, 'html.parser')
        ...
        # city = soup.find('h1', class_='yjw_cityname').text.strip()
        #今日の天気
        niftty_weather_today_0 = soup.select_one('#todayWeather > .moduleInner > table > tbody > tr + tr > td > img').get('alt')
        niftty_weather_today_3 = soup.select_one('#todayWeather > table >tbody > tr + tr > td + td > img alt')
        niftty_weather_today_6 = soup.select_one('#todayWeather > table >tbody > tr + tr > td + td + td > img alt')
        niftty_weather_today_9 = soup.select_one('#todayWeather > table >tbody > tr + tr > td + td + td + td > img alt')
        niftty_weather_today_12 = soup.select_one('#todayWeather > table >tbody > tr + tr > td + td + td + td + td > img alt')
        niftty_weather_today_15 = soup.select_one('#todayWeather > table >tbody > tr + tr > td + td + td + td + td + td > img alt')
        niftty_weather_today_18 = soup.select_one('#todayWeather > table >tbody > tr + tr > td + td + td + td + td + td + td > img alt')
        niftty_weather_today_21 = soup.select_one('#todayWeather > table >tbody > tr + tr > td + td + td + td + td + td + td + td > img alt')
        ...
        # return city, weather, temperature
        return yahoo_weather_today_0, yahoo_weather_today_3, yahoo_weather_today_6, yahoo_weather_today_9, yahoo_weather_today_12, yahoo_weather_today_15, yahoo_weather_today_18, yahoo_weather_today_21, yahoo_weather_tomorrow_0, niftty_weather_today_0, niftty_weather_today_3, niftty_weather_today_6, niftty_weather_today_9, niftty_weather_today_12, niftty_weather_today_15, niftty_weather_today_18, niftty_weather_today_21, niftty_weather_tomorrow_0
    else:
